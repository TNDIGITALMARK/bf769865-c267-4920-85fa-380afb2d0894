 ...
 * Build-Time Generated: 2025-09-13T19:04:09.439Z
 * Content Hash: 8456b778
 * 
 ...
 * 
 * Project ID: bf769865-c267-4920-85fa-380afb2d0894
 * Generated at: 2025-09-13T19:04:09.320Z
 * Framework: next.js
 * Type: app-router
 */
  ...
  if (typeof window !== 'undefined' && 
    ...
    class PhoenixTrackingClient {
      constructor() {
        ...
        this.debugMode = true;
        this.projectId = 'bf769865-c267-4920-85fa-380afb2d0894';
        this.userId = 'hw8u8FgXeBcQGo9CRezTWmEivX92';
        ...
        this.buildTime = '2025-09-13T19:04:09.320Z';
      ...
      setupTracking() {
        try {
          ...
          // Add data-phoenix-id attributes to components  
          this.addPhoenixIds();
      ...
      addPhoenixIds() {
        // Add tracking IDs to all interactive elements (same as runtime version)
        ...
        elements.forEach(element => {
          ...
          // Generate tracking data (same pattern as runtime version)
